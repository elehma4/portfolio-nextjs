    ...
    <div className='w-full'>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
        <div className='col-span-4'>
          <p>Project</p>
          <h2>Overview</h2>
          <p>I am currently working alongside the lead developer at DecOps developing a product called SimpFi.Ai where users can automate operational workflows using AI.<br /> 
          </p>
          <Link href='https://pathway-finance.netlify.app/'><button className='px-8 py-2 mt-4 mr-8'>Demo</button></Link>
          <Link href='https://github.com/ETH1Elohim/pathway-finance-reactjs'><button className='px-8 py-2 mt-4'>Code</button></Link>
        </div>
