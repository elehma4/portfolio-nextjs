    ...
    <div id='projects' className='w-full'>
        ...
        <div className='max-w-[1240px] mx-auto px-2 py-16'>
            ...
            <div className='grid md:grid-cols-2 gap-8'>
              <ProjectItem title="SimpFi.AI" description="SimpFi.AI is a product where users can automate operational workflows using AI" backgroundImg={simplifyImg} projectUrl='/simplify' />
