    ...
    <div id='about' className='w-full md:h-screen p-2 flex items-center py-16'>
        ...
        <div className='max-w-[1400px] m-auto md:grid grid-cols-3 gap-8'>
            <div className='col-span-2'>
                ...
                <p className='py-2 text-gray-600'>I'm a Junior Full-Stack Web Developer with a passion for leveraging technology to create positive impacts and prioritize security for web users. I am seeking opportunities to utilize my strengths and expertise in web development to contribute to innovative projects that enhance user experience, privacy, real-world interoperability, and digital freedom.</p>
